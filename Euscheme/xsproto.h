...
LVAL xltoofew(char *);
void xltoomany(char *);
void xltoofew_int(void);
void xltoomany_int(void);
...
LVAL xget(void);
LVAL xput(void);
LVAL xgetsyntax(void);
LVAL xputsyntax(void);
...
#ifdef sgi
/* SGI uses oserror for multiple threads errors */
#define oserror xs_oserror
#endif
